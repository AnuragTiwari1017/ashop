...
class Product(models.Model):
    ...
    pic1=models.ImageField(upload_to="uploads",default="",blank=True,null=True)
    pic2=models.ImageField(upload_to="uploads",default="",blank=True,null=True)
    pic3=models.ImageField(upload_to="uploads",default="",blank=True,null=True)
    pic4=models.ImageField(upload_to="uploads",default="",blank=True,null=True)
...
status=((0,"Order Placed"),(1,"Not Packed"),(2,"Packed"),(3,"Redy To Ship"),(4,"Shipped"),(5,"Out For Delivery"),(6,"Delivered"),(7,"Cancelled"))
